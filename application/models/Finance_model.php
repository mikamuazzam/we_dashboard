<?php
        ...
        if($status==1) $filter="and a.created_at >='2022-10-31'";
         ...
         $filter="and a.inv_date >='2022-10-31'";
            ...
            $sql="SELECT count(*)as jum,sum(a.based_value) as amount
                    ...
                    and inv_status_id=$status and  year(created_at) >=2023  group by inv_status_id";
    ...
    public function inv_list(){
        ...
        $sql = "SELECT e.company_name,d.name as productname, a.based_value amount_po,a.inv_number,
                    ...
                    where status_data=1   $filter and  year(a.created_at) >=2023";
        $db2 = $this->load->database('db2', TRUE);
        $query=$db2->query($sql);
    ...
    function total_po()
    {
        ...
        $sql="SELECT count(*)as jumlah FROM deals where id_stage in(3,5,6,7) and  year(created_at) >=2023";
