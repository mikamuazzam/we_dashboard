...
function ChartProgYTD(canvasid,website,bg1,bg2,bulan,tahun)
{
	$.ajax({
		...
		url : base_url+"/bispro_analisis/chart_prog_ytd",
		type : "GET",
...
function ChartProgMTD(canvasid,website,bg1,bg2,bulan,tahun)
{
	$.ajax({
		data :{website:website,bulan:bulan,tahun:tahun},
		url : base_url+"/bispro_analisis/chart_prog_mtd",
		type : "GET",
		success : function(data)
		{
...
function ChartAWARDMTD(canvasid,corebisnis,bg1,bg2,bulan,tahun)
{
	$.ajax({
		...
		url : base_url+"/bispro_analisis/chart_award_mtd",
		type : "GET",
		success : function(data)
		{
...
function ChartAWARDYTD(canvasid,corebisnis,bg1,bg2,bulan,tahun)
{
	$.ajax({
		data :{corebisnis:corebisnis,bulan:bulan,tahun:tahun},
		url : base_url+"/bispro_analisis/chart_award_ytd",
		type : "GET",
		success : function(data)
		{
...
function ChartWEYTD(canvasid,divisi,bg1,bg2,bulan,tahun)
{
	$.ajax({
		...
		url : base_url+"/bispro_analisis/chart_we_ytd",
		type : "GET",
		success : function(data)
		{
...
function ChartWEMTD(canvasid,divisi,bg1,bg2,bulan,tahun)
{
	$.ajax({
		data :{divid:divisi,bulan:bulan,tahun:tahun},
		url : base_url+"/bispro_analisis/chart_we_mtd",
		type : "GET",
		success : function(data)
		{
...
function ChartAEYTD(bulan,tahun)
{
	$.ajax({
		...
		url : base_url+"/bispro_analisis/chart_ae_ytd",
		type : "GET",
		success : function(data)
		{
...
function ChartAEMTD(bulan,tahun)
{
	$.ajax({
		data :{bulan:bulan,tahun:tahun},
		url : base_url+"/bispro_analisis/chart_ae_mtd",
		type : "GET",
		success : function(data)
		{
